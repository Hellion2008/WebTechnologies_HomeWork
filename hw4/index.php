...
$jobs = [
    [
        'name' => 'Обследователь зданий и сооружений',
        'date' => 'Aug 2016',
    ...
    [
        ...
        'description' => 'Вот такая работка тоже была, грязная и матерная',
    ],
    
    [
        'name' => 'Проектировщик',
        'date' => 'Jun 2012 - Jul 2014',
        'description' => 'Считал здания и сооружения на прочность'
    ],
    
    [
        'name' => 'Домашний раб',
        'date' => 'Jun 2012',
        'description' => 'Все такими были',
    ],
];
?>
